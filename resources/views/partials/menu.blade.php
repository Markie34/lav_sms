<div class=" sidebar sidebar-dark sidebar-main sidebar-expand-md  overflow-hidden">
  ...
  <svg
    ...
    style="fill: #ffffff; width: 193%; height: 65px;"
    class="opacity-50"
  >
    <path
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['exams.index', 'exams.edit', 'grades.index', 'grades.edit', 'marks.index', 'marks.manage', 'marks.bulk', 'marks.tabulation', 'marks.show', 'marks.batch_fix',]) ? 'nav-item-expanded nav-item-open' : '' }} ">
                    ...
                    <!-- <ul class="nav nav-group-sub text-center py-2" data-submenu-title="Manage Exams">
                    <p class="">Feature Comming Soon</p>
                    </ul> -->
                </li>
                @endif 

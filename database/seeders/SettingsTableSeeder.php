...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'system_title', 'description' => 'FUJI'],
            ['type' => 'system_name', 'description' => 'FUJI Japanese Learning Training Center'],
            ['type' => 'term_ends', 'description' => '7/10/2023'],
            ['type' => 'term_begins', 'description' => '7/10/2024'],
            ['type' => 'phone', 'description' => '0123456789'],
            ['type' => 'address', 'description' => 'mt. view Fuji'],
            ['type' => 'system_email', 'description' => 'fuji@cj.com'],
